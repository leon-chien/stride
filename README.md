...
### Version 1.4: Gated rare-event benchmark

To test whether learned trajectory-value binning is useful when distance alone is insufficient, STRIDE introduced a gated rare-event benchmark. The event is defined as:
